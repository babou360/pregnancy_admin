...
import 'package:mama_k_app_admin/Screens/mother/addMother.dart';
...
class MotherPage extends StatefulWidget {
  @override
  _MotherPageState createState() => _MotherPageState();
}
          ...
          child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        child: Text('MOTHER',style: TextStyle(fontWeight: FontWeight.w700),)
                      ),
                      GestureDetector(
                        onTap: ()=> Navigator.push(context, MaterialPageRoute(builder: (context) =>AddMother())),
                        child: Container(
