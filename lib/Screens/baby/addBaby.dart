                ...
                Container(
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          child: Text('Select Week>>',style: TextStyle(fontWeight: FontWeight.w700)),
                        ),
   ...
   if(!_formKey.currentState.validate()){
     Scaffold.of(context).showSnackBar(
       ...
       .child('images/${Path.basename(_image.path)}}');    
        ...
        .then((url) {
          FirebaseFirestore.instance.collection('baby').doc(_week).set({
            'week': _week,
            'image':url,
            'title': title,
        ...
        Navigator.push(context, MaterialPageRoute(builder: (context) => BabyPage()));
     }
   }
  }
}